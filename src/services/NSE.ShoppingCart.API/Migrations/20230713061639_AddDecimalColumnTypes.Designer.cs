...
namespace NSE.ShoppingCart.API.Migrations
{
    ...
    [Migration("20230713061639_AddDecimalColumnTypes")]
    partial class AddDecimalColumnTypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSE.ShoppingCart.API.Model.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NSE.ShoppingCart.API.Model.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NSE.ShoppingCart.API.Model.CarrinhoCliente", b =>
                {
                    b.OwnsOne("NSE.ShoppingCart.API.Model.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("NSE.ShoppingCart.API.Model.CarrinhoItem", b =>
                {
                    b.HasOne("NSE.ShoppingCart.API.Model.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
