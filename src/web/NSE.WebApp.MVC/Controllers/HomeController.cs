...
namespace NSE.WebApp.MVC.Controllers
{
    public class HomeController : MainController
    {
        ...
        public IActionResult SistemaIndisponivel()
        {
            ...
            {
                Mensagem = "O sistema está temporariamente indisponível, isto pode ocorrer em momentos de sobrecarga de utilizadores.",
        ...
        public IActionResult Error(int id)
        {
            ...
            else if(id == 404)
            {
                ...
                modelErro.Titulo = "Ups! Página não encontrada!";
                modelErro.ErroCode = id;
            }
            else if (id == 403)
            {
                modelErro.Mensagem = "Você não tem permissão para fazer esta ação.";
